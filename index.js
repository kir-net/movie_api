...
app.get('/subfolder/subsubfolder/:directorsName', (req, res) => {
  Movies
...
// OK Read: get user info, by username
...
app.post('/users/:Username/movies/:addMovieID', (req, res) => {
  Users
  .findOneAndUpdate(
...
app.delete('/Users/:Username/Movies/:removeMovieID', (req, res) => {
  Users
  .findOneAndUpdate(
    {Username: req.params.Username}, 
